...
// Mirrors the player's picker so the two apps feel like one product. It reuses
// the engine's design tokens rather than redefining any colour, so it can't
// drift from the palette (§11).
const PICKER_CSS = `
.xwp { overflow: hidden; }
.xwp-head {
  flex: 0 0 auto;
  ...
  return (
    <div className="xw xwp">
      ...
      <header className="xwp-head">
        <h1 className="xwp-title">Scramble</h1>
        <div className="xwp-sub">{minis.length} minis · rearrange the letters to solve</div>
      </header>
